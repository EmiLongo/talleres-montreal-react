...
export const Title1 = styled((props: TypographyProps) => <Typography {...props} />)(({ theme }) => ({
  ...defaultTitle(theme),
  ...responsiveFontSize({ xl: '1.5rem', lg: '1.375rem', md: '1.325rem', sm: '1.3rem', xs: '1.3rem' })(theme), // 24px
  textWrap: "wrap",
}));

export const Title2 = styled((props: TypographyProps) => <Typography {...props} />)(({ theme }) => ({
  ...defaultTitle(theme),
  ...responsiveFontSize({ xl: '1.25rem', lg: '1.15rem', md: '1.1rem', sm: '1.05rem', xs: '1.05rem' })(theme), // 20px
  textWrap: "wrap",
}));
...
export const SubtitleXL = styled((props: TypographyProps) => <Typography {...props} />)(({ theme }) => ({
  ...
  ...responsiveFontSize({ xl: "1.5rem", lg: "1.375rem", md: "1.32rem", sm: "1.27rem", xs: "1.27rem"})(theme), // 18px
  textWrap: "wrap",
}));
